...
const LoadingPage = ({ children }: { children: ReactNode }) => {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-emerald-100 dark:bg-gray-900">
      <div className="flex flex-col items-center">
        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 w-16 h-16 rounded-full border-r-2 border-transparent border-opacity-50" />
        </div>
