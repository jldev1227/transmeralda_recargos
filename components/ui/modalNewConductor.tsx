...
export default function ModalNewConductor() {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setFormData((prev: Partial<Conductor>) => ({
      ...prev,
      [name]: value,
    }));
          ...
          case 400: // Bad Request
            ...
            if (
              ...
              if (errorDescription.toLowerCase().includes("nombre")) {
                ...
                errorDescription = "Ya existe un conductor con este Nombre.";
              } else if (errorDescription.toLowerCase().includes("numero_identificacion")) {
                errorTitle = "Documento duplicado";
                errorDescription = "Ya existe un conductor con este Documento.";
              }
            }
            break;
  ...
  const handleSave = () => {
    ...
    if (nuevosErrores.nombre || nuevosErrores.apellido || nuevosErrores.numero_identificacion) {
      return;
    }
              ...
              <ModalBody>
                <div className="space-y-4">
                  ...
                  <Input
                    ...
                    type="number"
                    value={formData.numero_identificacion?.toString() || ""}
                    onChange={(e) => {
                        setFormData((prev: Partial<Conductor>) => ({
                        ...prev,
                        numero_identificacion: Number(e.target.value),
                        }));
                    }}
                  />
